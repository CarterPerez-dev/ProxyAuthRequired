...
export default PhishingPhrenzy;// src/components/pages/games/PhishingPhrenzy/PhishingPhrenzy.js
import React, { useState, useEffect, useRef } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { FaShieldAlt, FaSkullCrossbones, FaClock, FaTrophy } from 'react-icons/fa';
import { 
...
const PhishingPhrenzy = () => {
  ...
  if (loading) {
    return <div className="phishing-loading">Loading game data...</div>;
  }

  if (error) {
    return <div className="phishing-error">Error loading game: {error}</div>;
  }

  return (
    <div className="phishing-phrenzy-container">
      ...
      {gameStatus === 'idle' ? (
        <div className="phishing-start-screen">
          <h2>Ready to test your phishing detection skills?</h2>
          <p>You'll be shown various emails, messages, and websites. Quickly decide if they're legitimate or phishing attempts.</p>
        ...
        <div className="phishing-gameplay">
